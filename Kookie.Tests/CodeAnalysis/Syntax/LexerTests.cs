...
namespace Kookie.Tests.CodeAnalysis.Syntax
{
    public class LexerTests
    {
        ...
        {
            return GetTokenPairsWithSeparator().Select(t => new object[] {t.t1Kind, t.t1Text, t.separatorKind, t.separatorText, t.t2Kind, t.t2Text});
        }
        ...
        private static IEnumerable<(SyntaxKind kind, string text)> GetTokens()
        {
            var fixedTokens = Enum.GetValues(typeof(SyntaxKind))
                .Cast<SyntaxKind>()
                .Select(k => (SyntaxKind: k, text: SyntaxFacts.GetText(k)))
                .Where(t => t.text != null);
